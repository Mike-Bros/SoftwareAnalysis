...
var pIntro =   "You are given a board in which numbered tiles can slide around. "
              + "There is one blank space that holds no tile.  A legal move "
              + "consists of sliding a tile into the blank space if the tile is "
              + "adjacent to it. The goal is to move tiles around until they are "
              + "arranged in numerical order clockwise from the upper left."; // Introductory text
